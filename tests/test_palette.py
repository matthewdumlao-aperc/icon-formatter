...
from src.config.icon import GRAY, WHITE
...
class PaletteNormalizationTests(unittest.TestCase):
    def test_crops_alpha_fills_transparency_and_snaps_colors(self):
        ...
        self.assertTrue(report.cropped_transparent_margin)
        ...
        self.assertLessEqual(visible, {WHITE, GRAY})
